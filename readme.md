...
Sidewinder provides similar functionality to GRPC but uses JSON RPC 2.0 for the wire protocol, JSON Schema for message validation and optional binary message encoding using MsgPack.
