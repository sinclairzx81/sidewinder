...
//         const R = Extends.Check(
//             Type.Constructor([], Type.Number()),
//             Type.Constructor([], Type.Number())
//         )
...
//         const R = Extends.Check(
//             Type.Constructor([Type.Number()], Type.Number()),
//             Type.Constructor([], Type.Any())
//         )
...
//         type T = (new (a: number | string) => number) extends (new (a: number) => any) ? 1 : 2
//         const R = Extends.Check(
//             Type.Constructor([Type.Union([Type.Number(), Type.String()])], Type.Number()),
//             Type.Constructor([Type.Number()], Type.Any())
//         )
//         Assert.deepEqual(R, ExtendsResult.True)
//     })
...
//     //     const R = Extends.Check(
//     //         Type.Constructor([Type.Number()], Type.Number()),
//     //         Type.Constructor([Type.Union([Type.Number(), Type.String()])], Type.Any())
//     //     )
//     //     Assert.deepEqual(R, ExtendsResult.False)
//     // })
...
//     //     const R = Extends.Check(
//     //         Type.Constructor([Type.Number(), Type.Number()], Type.Number()),
//     //         Type.Constructor([Type.Number()], Type.Number())
//     //     )
//     //     Assert.deepEqual(R, ExtendsResult.False)
//     // })
...
//     //     const R = Extends.Check(
//     //         Type.Constructor([], Type.Array(Type.Any())),
//     //         Type.Constructor([], Type.Object({}))
//     //     )
//     //     Assert.deepEqual(R, ExtendsResult.True)
//     // })
...
//     //     const R = Extends.Check(
//     //         Type.Constructor([], Type.Array(Type.String())),
//     //         Type.Constructor([], Type.Object({}))
//     //     )
//     //     Assert.deepEqual(R, ExtendsResult.True)
//     // })
