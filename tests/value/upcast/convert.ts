...
describe('value/convert/String', () => {
  it('Should convert string', () => {
    const value = 'hello'
    const result = Value.Upcast(Type.String(), value)
...
describe('value/convert/Number', () => {
  it('Should convert string #1', () => {
    const value = 'hello'
    const result = Value.Upcast(Type.Number(), value)
...
describe('value/convert/Integer', () => {
  it('Should convert string #1', () => {
    const value = 'hello'
    const result = Value.Upcast(Type.Integer(), value)
    Assert.deepEqual(result, 0)
  })
...
describe('value/convert/Boolean', () => {
  it('Should convert string #1', () => {
    const value = 'hello'
    const result = Value.Upcast(Type.Boolean(), value)
    Assert.deepEqual(result, false)
  })
  ...
  it('Should convert string #7', () => {
    const value = '0'
    const result = Value.Upcast(Type.Boolean({ default: true }), value)
    Assert.deepEqual(result, false)
  })

  it('Should convert string #8', () => {
    const value = '1'
    const result = Value.Upcast(Type.Boolean({ default: false }), value)
    Assert.deepEqual(result, true)
  })
