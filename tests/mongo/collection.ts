...
describe('mongo/MongoCollection', () => {
  ...
  it(
    'should not insertOne with invalid document',
    resolve.database(async (database) => {
      const vectors = database.collection('vectors')
      // @ts-ignore
  ...
  it(
    'should insertMany with options',
    resolve.database(async (database) => {
      const vectors = database.collection('vectors')
      const result = await vectors.insertMany(
        [
  ...
  it(
    'should not insertMany with invalid document',
    resolve.database(async (database) => {
      const vectors = database.collection('vectors')
  ...
  it(
    'should not updateOne with invalid document',
    resolve.database(async (database) => {
      const vectors = database.collection('vectors')
      const _id0 = database.id()
      await vectors.insertOne({ _id: _id0, x: 1, y: 2, z: 3 })
  ...
  it(
    'should not updateOne with partial document on upsert',
    resolve.database(async (database) => {
      const vectors = database.collection('vectors')
      const _id0 = database.id()
  ...
  it(
    'should updateMany with options',
    resolve.database(async (database) => {
      const vectors = database.collection('vectors')
      const _id0 = database.id()
      const _id1 = database.id()
  ...
  it(
    'should not updateMany with invalid document',
    resolve.database(async (database) => {
      const vectors = database.collection('vectors')
      const _id0 = database.id()
      const _id1 = database.id()
  ...
  it(
    'should not updateMany with partial document on upsert',
    resolve.database(async (database) => {
      const vectors = database.collection('vectors')
      const _id0 = database.id()
      const _id1 = database.id()
  ...
  it(
    'should deleteOne with common property',
    resolve.database(async (database) => {
      const vectors = database.collection('vectors')
      const _id0 = database.id()
      const _id1 = database.id()
