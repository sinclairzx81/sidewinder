...
describe('Cursor', () => {
    ...
    it('should support toArray', resolve.database(async database => {
    ...
    it('should support skip', resolve.database(async database => {
        const vectors = database.collection('vectors')
        await createTestData(database, vectors)
    ...
    it('should support take', resolve.database(async database => {
        const vectors = database.collection('vectors')
        await createTestData(database, vectors)
    ...
    it('should support skip and take', resolve.database(async database => {
        const vectors = database.collection('vectors')
        await createTestData(database, vectors)
    ...
    it('should support sort', resolve.database(async database => {
        const vectors = database.collection('vectors')
        await createTestData(database, vectors)
    ...
    it('should support async iterator', resolve.database(async database => {
        const vectors = database.collection('vectors')
        await createTestData(database, vectors)
        const result: any[] = []
